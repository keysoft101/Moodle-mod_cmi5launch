...
Once the plugin is downloaded, be sure it is entirely in a folder named 'cmi5launch.' Then compress that folder into zip. The zip file _must_ be named 'cmi5_moodle.zip' to be uploaded to Moodle.
